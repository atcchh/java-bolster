...
public class CustomerDAO {
    ...
    public Integer insertCustomer(CustomerDTO c) {
        return jdbcTemplate.update("insert into customer (id, name, age) values (?,?,?)", new Object[]{c.getId(),c.getName(),c.getAge()}, new int[]{Types.INTEGER, Types.VARCHAR, Types.INTEGER});
    }
}
